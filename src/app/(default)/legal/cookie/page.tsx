...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations({ locale: "en", namespace: "legal.cookie.seo" });
  
  return {
    title: t("title"),
    description: t("description"),
    alternates: {
      canonical: `${siteUrl}/legal/cookie`,
    },
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: `${siteUrl}/legal/cookie`,
    },
    twitter: {
      title: t("title"),
      description: t("description"),
...
export default async function CookiePolicyPage() {
  const t = await getTranslations({ locale: "en", namespace: "legal.cookie.page" });
